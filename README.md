...
- [FAQ](#faq)
  - [I have a custom type that I need to support. How do I do that?](#ihaveacustomtypethatineedtosupporthowdoidothat)
  - [Do you support faker/chance/falso?](#doyousupportfakerchancefalso)
- [API](#api)
  - [Fixture / Transformer](#fixturetransformer)
    - [Config](#config)
      - [Seed (optional)](#seedoptional)
      - [Defaults (optional)](#defaultsoptional)
- [Advanced Topics](#advancedtopics)
  - [Create Your Own Transformer](#createyourowntransformer)
- [Contributing](#contributing)
  - [Getting started with GitHub Codespaces](#gettingstartedwithgithubcodespaces)
